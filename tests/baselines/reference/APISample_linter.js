...
declare module "typescript" {
    ...
    const enum SyntaxKind {
        ...
        Parameter = 128,
        Decorator = 129,
        PropertySignature = 130,
        PropertyDeclaration = 131,
        MethodSignature = 132,
        MethodDeclaration = 133,
        Constructor = 134,
        GetAccessor = 135,
        SetAccessor = 136,
        CallSignature = 137,
        ConstructSignature = 138,
        IndexSignature = 139,
        TypeReference = 140,
        FunctionType = 141,
        ConstructorType = 142,
        ...
        ObjectBindingPattern = 149,
        ArrayBindingPattern = 150,
        BindingElement = 151,
        ArrayLiteralExpression = 152,
        ObjectLiteralExpression = 153,
        PropertyAccessExpression = 154,
        ElementAccessExpression = 155,
        CallExpression = 156,
        NewExpression = 157,
        TaggedTemplateExpression = 158,
        TypeAssertionExpression = 159,
        ParenthesizedExpression = 160,
        FunctionExpression = 161,
        ArrowFunction = 162,
        DeleteExpression = 163,
        TypeOfExpression = 164,
        VoidExpression = 165,
        PrefixUnaryExpression = 166,
        PostfixUnaryExpression = 167,
        BinaryExpression = 168,
        ConditionalExpression = 169,
        TemplateExpression = 170,
        YieldExpression = 171,
        SpreadElementExpression = 172,
        OmittedExpression = 173,
        TemplateSpan = 174,
        Block = 175,
        VariableStatement = 176,
        EmptyStatement = 177,
        ...
        ThrowStatement = 191,
        TryStatement = 192,
        DebuggerStatement = 193,
        VariableDeclaration = 194,
        VariableDeclarationList = 195,
        FunctionDeclaration = 196,
        ClassDeclaration = 197,
        InterfaceDeclaration = 198,
        TypeAliasDeclaration = 199,
        EnumDeclaration = 200,
        ModuleDeclaration = 201,
        ModuleBlock = 202,
        ...
        NamedExports = 211,
        ExportSpecifier = 212,
        IncompleteDeclaration = 213,
        ExternalModuleReference = 214,
        CaseClause = 215,
        DefaultClause = 216,
        HeritageClause = 217,
        CatchClause = 218,
        PropertyAssignment = 219,
        ShorthandPropertyAssignment = 220,
        EnumMember = 221,
        SourceFile = 222,
        SyntaxList = 223,
        Count = 224,
...
function delint(sourceFile) {
    ...
    function delintNode(node) {
        switch (node.kind) {
            case 182 /* ForStatement */:
            case 183 /* ForInStatement */:
            case 181 /* WhileStatement */:
            case 180 /* DoStatement */:
                if (node.statement.kind !== 175 /* Block */) {
                    report(node, "A looping statement's contents should be wrapped in a block body.");
                }
                break;
            case 179 /* IfStatement */:
                var ifStatement = node;
                if (ifStatement.thenStatement.kind !== 175 /* Block */) {
                    report(ifStatement.thenStatement, "An if statement's contents should be wrapped in a block body.");
                }
                if (ifStatement.elseStatement && ifStatement.elseStatement.kind !== 175 /* Block */ && ifStatement.elseStatement.kind !== 179 /* IfStatement */) {
                    report(ifStatement.elseStatement, "An else statement's contents should be wrapped in a block body.");
                }
                break;
            case 168 /* BinaryExpression */:
