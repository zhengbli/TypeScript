...
declare module "typescript" {
    ...
    const enum SyntaxKind {
        ...
        OfKeyword = 123,
        QualifiedName = 124,
        ComputedPropertyName = 125,
        TypeParameter = 126,
        Parameter = 127,
        PropertySignature = 128,
        PropertyDeclaration = 129,
        MethodSignature = 130,
        ...
        TupleType = 144,
        UnionType = 145,
        ParenthesizedType = 146,
        ObjectBindingPattern = 147,
        ArrayBindingPattern = 148,
        BindingElement = 149,
        ArrayLiteralExpression = 150,
        ObjectLiteralExpression = 151,
        PropertyAccessExpression = 152,
        ElementAccessExpression = 153,
        CallExpression = 154,
        NewExpression = 155,
        TaggedTemplateExpression = 156,
        TypeAssertionExpression = 157,
        ParenthesizedExpression = 158,
        FunctionExpression = 159,
        ArrowFunction = 160,
        DeleteExpression = 161,
        TypeOfExpression = 162,
        VoidExpression = 163,
        ...
        YieldExpression = 169,
        SpreadElementExpression = 170,
        OmittedExpression = 171,
        TemplateSpan = 172,
        Block = 173,
        VariableStatement = 174,
        EmptyStatement = 175,
        ...
        ModuleBlock = 200,
        ImportEqualsDeclaration = 201,
        ImportDeclaration = 202,
        ImportClause = 203,
        NamespaceImport = 204,
        NamedImports = 205,
        ImportSpecifier = 206,
        ExportAssignment = 207,
        ExportDeclaration = 208,
        NamedExports = 209,
        ExportSpecifier = 210,
        ExternalModuleReference = 211,
        CaseClause = 212,
        DefaultClause = 213,
        HeritageClause = 214,
        CatchClause = 215,
        PropertyAssignment = 216,
        ShorthandPropertyAssignment = 217,
        EnumMember = 218,
        SourceFile = 219,
        SyntaxList = 220,
        Count = 221,
...
function delint(sourceFile) {
    ...
    function delintNode(node) {
        switch (node.kind) {
            case 180 /* ForStatement */:
            case 181 /* ForInStatement */:
            case 179 /* WhileStatement */:
            case 178 /* DoStatement */:
                if (node.statement.kind !== 173 /* Block */) {
                    report(node, "A looping statement's contents should be wrapped in a block body.");
                }
                break;
            case 177 /* IfStatement */:
                var ifStatement = node;
                if (ifStatement.thenStatement.kind !== 173 /* Block */) {
                    report(ifStatement.thenStatement, "An if statement's contents should be wrapped in a block body.");
                }
                if (ifStatement.elseStatement && ifStatement.elseStatement.kind !== 173 /* Block */ && ifStatement.elseStatement.kind !== 177 /* IfStatement */) {
                    report(ifStatement.elseStatement, "An else statement's contents should be wrapped in a block body.");
                }
                break;
            case 166 /* BinaryExpression */:
