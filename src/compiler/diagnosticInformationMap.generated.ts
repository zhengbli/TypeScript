...
module ts {
    export var Diagnostics = {
        ...
        Decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1195, category: DiagnosticCategory.Error, key: "Decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        _0_is_obsolete: { code: 1196, category: DiagnosticCategory.Error, key: "'{0}' is obsolete." },
        _0_is_obsolete_Colon_1: { code: 1197, category: DiagnosticCategory.Error, key: "'{0}' is obsolete: '{1}'" },
        Decorators_cannot_appear_here: { code: 1198, category: DiagnosticCategory.Error, key: "Decorators cannot appear here." },
        Non_ambient_decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1199, category: DiagnosticCategory.Error, key: "Non-ambient decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        ...
        Export_declaration_conflicts_with_exported_declaration_of_0: { code: 2485, category: DiagnosticCategory.Error, key: "Export declaration conflicts with exported declaration of '{0}'" },
        Cannot_find_global_decorator_function_0: { code: 2486, category: DiagnosticCategory.Error, key: "Cannot find global decorator function '{0}'." },
