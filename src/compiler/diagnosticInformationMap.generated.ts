...
module ts {
    export var Diagnostics = {
        ...
        _0_decorator_already_specified: { code: 1202, category: DiagnosticCategory.Error, key: "'{0}' decorator already specified." },
        Decorators_may_not_change_the_type_of_a_member: { code: 1203, category: DiagnosticCategory.Error, key: "Decorators may not change the type of a member." },
        Decorators_may_not_change_the_type_of_a_class: { code: 1204, category: DiagnosticCategory.Error, key: "Decorators may not change the type of a class." },
        _0_is_obsolete: { code: 1205, category: DiagnosticCategory.Error, key: "'{0}' is obsolete." },
        _0_is_obsolete_Colon_1: { code: 1206, category: DiagnosticCategory.Error, key: "'{0}' is obsolete: '{1}'" },
