...
module ts {
    export var Diagnostics = {
        ...
        Decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1192, category: DiagnosticCategory.Error, key: "Decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        _0_is_obsolete: { code: 1202, category: DiagnosticCategory.Error, key: "'{0}' is obsolete." },
        _0_is_obsolete_Colon_1: { code: 1203, category: DiagnosticCategory.Error, key: "'{0}' is obsolete: '{1}'" },
        Decorators_cannot_appear_here: { code: 1196, category: DiagnosticCategory.Error, key: "Decorators cannot appear here." },
        Non_ambient_decorators_are_only_supported_on_class_members_when_targeting_ECMAScript_5_or_higher: { code: 1197, category: DiagnosticCategory.Error, key: "Non-ambient decorators are only supported on class members when targeting ECMAScript 5 or higher." },
        Decorator_0_is_not_valid_on_this_declaration_type_It_is_only_valid_on_1_declarations: { code: 1198, category: DiagnosticCategory.Error, key: "Decorator '{0}' is not valid on this declaration type. It is only valid on '{1}' declarations." },
        Decorator_0_is_not_valid_on_this_declaration_type: { code: 1199, category: DiagnosticCategory.Error, key: "Decorator '{0}' is not valid on this declaration type." },
        Decorator_is_not_valid_on_this_declaration_type: { code: 1200, category: DiagnosticCategory.Error, key: "Decorator is not valid on this declaration type." },
        Argument_to_ambient_decorator_must_be_constant_expression: { code: 1201, category: DiagnosticCategory.Error, key: "Argument to ambient decorator must be constant expression." },
        ...
        Export_declaration_conflicts_with_exported_declaration_of_0: { code: 2482, category: DiagnosticCategory.Error, key: "Export declaration conflicts with exported declaration of '{0}'" },
        Cannot_find_global_decorator_function_0: { code: 2483, category: DiagnosticCategory.Error, key: "Cannot find global decorator function '{0}'." },
        ...
        SYMBOL: { code: 6057, category: DiagnosticCategory.Message, key: "SYMBOL" },
