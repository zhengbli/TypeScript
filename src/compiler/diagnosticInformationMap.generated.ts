...
module ts {
    export var Diagnostics = {
        ...
        Export_declaration_conflicts_with_exported_declaration_of_0: { code: 2478, category: DiagnosticCategory.Error, key: "Export declaration conflicts with exported declaration of '{0}'" },
